...
<body>
    ...
    <section class="contacto bg-primary" id="contactenos">
        <h2>¡CONTÁCTANOS!</h2>
        ...
        <div>
            <form action="">
                ...
                <textarea name="mensaje" id="msj" cols="30" rows="10">Escriba aquí su opinión, duda o sugerencia.</textarea>
                <a href="contactanos.html"><button type="button" value="Enviar" id="btnEnviar">Enviar</button></a>
            </form>
        </div>
    </section>
    <!-- /CONTÁCTANOS -->
