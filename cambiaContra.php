    ...
    <section class="seccion-perfil-usuario">
            ...
            ?>
                <div class="perfil-usuario-footer">
                    <form action="./dasborad/acciones/cambiarContra.php">
                            <div class="mb-3">
                                <label class="from-lable">Contraseña actual</label>
                                <input type="txt" name="Contrasenaactual" class="form-control">


                            </div>
                            <div class="mb-3">
                                <label class="from-lable">Nueva contraseña</label>
                                <input type="txt" name="Contra" class="form-control">



                            </div>
                            <div class="mb-3">
                                <label class="from-lable">Confirmar contraseña</label>
                                <input type="txt" name="Cofirmacion" class="form-control">
                                


                            </div>
                            <div class="boton">
                                <input type="submit" name="enviar" value="Aceptar" class="siuu primaryhh ">
                            </div>
