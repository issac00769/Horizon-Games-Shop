...
<head>
	...
	<link rel="stylesheet" href="css/stylesUsuariosjj.css">
	...
	<body>
		...
		<div class="content-all">
			<div class="content-carrousel">
				...
				?>
				<figure>
					<a href="./informacion_del_producto.php ?id=<?php echo $fila["IdProducto"] ?>">
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="section-title text-center">
						<h3 class="title">JUEGOS DESTACADOS</h3>
					</div>
				</div>
				...
				<div class="col-md-3 col-xs-6">
					<div class="product">
						...
						<div class="product-body">
							<p class="product-category"><?php echo $fila["Id_Marca"] ?></p>
							<h3 class="product-name"><?php echo $fila["NombreProducto"] ?></a></h3>
							<h4 class="product-price">$ <?php echo $fila["Precio"] ?></h4>
							<div class="product-btns">
								<button class="add-to-wishlist"><a href="informacion_del_producto.php ?id=<?php echo $fila["IdProducto"] ?>">COMPRAR</a></i></button>
							</div>
						</div>
					</div>
				</div>
