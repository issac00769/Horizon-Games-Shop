            ...
            <section class="seccion-perfil-usuario">
                ...
                <div class="perfil-usuario-body">
                    ...
                    <div class="perfil-usuario-bio">
                        ...
                        $consulta = "SELECT producto.IdProducto, producto.NombreProducto, producto.Precio, producto.stock, producto.foto, marca.NombreMarca FROM producto 
                        INNER JOIN marca ON producto.Id_Marca = marca.IdMarca WHERE IdProducto = '$idP';";
                        ...
                        <table class="margen">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="align-middle ">
                                        <span class="text-secondary text-xs font-weight-bold"><?php echo $fila["stock"] ?></span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="perfil-usuario-footer">
                        ...
                        <form action="./dasborad/acciones/insertarVenta.php" method="POST">

                            <div class="mb-3">
                                <input type="hidden" name="Idcliente" value="<?php echo $idU; ?>">
                            </div>

                            <div class="mb-3">
                                <input type="hidden" name="idproducto" value="<?php echo $idP; ?>">


                            </div>

                            <div class="mb-3">
                                <label class="from-lable">Cantidad a perdir</label>
                                <label class="from-lable form-control">1</label>
                            ...
                            <div class="mb-3">
                                <label class="from-lable ">Total de la compra (Incluido el IVA)</label>
                                <label class="from-lable form-control">$ <?php echo $fila["Precio"]?></label>
                        ...
                        <form action="index.php">
                            <div class="boton">
                                <input type="submit" value="cancelar" class="siuu colorD">
                            </div>
